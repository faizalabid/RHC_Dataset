...
class RHC(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        img, den, den2 = self.read_image_and_gt(fname)      
    ...
    def read_image_and_gt(self,fname):
        ...
        den2 = pd.read_csv(os.path.join(self.gt2_path,os.path.splitext(fname)[0] + '.csv'), sep=',',header=None).values
        den2 = den.astype(np.float32, copy=False)    
        den2 = Image.fromarray(den2) 
